package 
{
	...
	public class AllAlongTheJordans extends MovieClip 
	{
		...
		public function startAllAlongTheJordans() 
		{
...
function everyFrame(event:Event):void {
	...
	if (rightArrow == false && leftArrow == false && downArrow == false && upArrow == false)
	{
		Char.gotoAndStop(1);
	}
}
...
//				checkCollisionsPig();
		...
		{
			gamesprite.x = -gamesprite.guy.x + 275;
			gamesprite.y = -gamesprite.guy.y + 200;
		}
...
//		}
		...
		public function moveGuy(timeDiff:Number) 
		{
			...
			if ((newGuyRect.bottom > mapRect.bottom) && (guyRect.bottom <= mapRect.bottom)) 
			{
